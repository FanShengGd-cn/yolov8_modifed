...
label_idx_map = {'leaf': 0, 'Gray leaf spot of Anhui peppermint': 1}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_dir', type=str, default='C:\\Users\\xiang\\Desktop\\train',
                        help='Please input the path of the labelme json files.')
    parser.add_argument('--val_size', type=float, nargs='?', default=0.3,
