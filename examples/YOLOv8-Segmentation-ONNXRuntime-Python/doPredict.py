...
sys.path.append("d:/Downloads/ultralytics")
from ultralytics import YOLO
from torchsummary import summary

if __name__ == '__main__':
    # 加载模型
    model = YOLO(r'./runs/train\GAM_ATT_coslr_not-overlap-mask\weights\best.pt')  # YOLOv8n模型
    model.predict(
    ...
    # summary(Conv(1,3,2).to(torch.device("cuda")), (1, 640,640))
    # (model, img_path, save_path, transform=None, visual_heatmap=False):
